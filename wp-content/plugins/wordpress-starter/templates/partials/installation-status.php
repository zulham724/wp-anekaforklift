...
<div class="container container--padding-large container--elevation-1 banner--wizard <?php echo ( 'failed' === $status['status'] ) ? 'banner--wizard-warning' : 'banner--wizard-info' ?>">
	<div class="flex flex--gutter-none flex--margin-none flex--align-center">
		<div class="box box--direction-row box--sm-12 typography typography--align-center">
			...
			<p class="text text--size-medium typography--weight-light with-color with-color--color-white">
				<?php esc_html_e( 'Select design, functionality and marketing plugins and start working on your site right away!', 'siteground-wizard' ); ?>
			</p>
