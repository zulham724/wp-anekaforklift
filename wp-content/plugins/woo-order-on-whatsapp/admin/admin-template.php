...
function evowap_add_admin_page() {
    ...
    add_menu_page( 'Woo Order on WhatsApp Options', 'Woo Order on WhatsApp', 'manage_options', 'evowap_plugin_config', 'evowap_create_admin_page', plugin_dir_url( __FILE__ ) . '/img/whatsapp.png', 56 );
